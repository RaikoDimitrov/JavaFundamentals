...
public class HeroesOfCodeAndLogic {
    ...
    public static void main(String[] args) {
        ...
        while (!command.equals("End")) {
            ...
            switch (commandName) {
                case "CastSpell" -> handleCastSpell(heroes, commandParts[1], Integer.parseInt(commandParts[2]), commandParts[3]);
                case "TakeDamage" -> handleTakeDamage(heroes, commandParts[1], Integer.parseInt(commandParts[2]), commandParts[3]);
                case "Recharge" -> handleRecharge(heroes, commandParts[1], Integer.parseInt(commandParts[2]));
                case "Heal" -> handleHeal(heroes, commandParts[1], Integer.parseInt(commandParts[2]));
                default -> throw new IllegalStateException("Unknown command " + commandName + " in " + command);
            }
